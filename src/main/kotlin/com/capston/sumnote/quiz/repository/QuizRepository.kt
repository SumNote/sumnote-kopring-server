...
interface QuizRepository : JpaRepository<Quiz, Long> {
    ...
    @Query("SELECT new com.capston.sumnote.quiz.dto.GetQuizzesDto(q.id, q.title, q.createdAt, q.lastModifiedAt) FROM Quiz q WHERE q.member.email = :email ORDER BY q.lastModifiedAt DESC LIMIT 5")
    fun findTop5ByMemberEmailOrderByLastModifiedAtDesc(email: String): List<GetQuizzesDto>
    ...
    fun findAllByMemberEmailOrderByLastModifiedAtDesc(email: String): List<GetQuizzesDto>
}